...
document.addEventListener("DOMContentLoaded", function () {
    ...
    var particleColors = {
        light: { particle: "#1E5A9C", line: "#3E8FD6" },
        dark:  { particle: "#5BC0BE", line: "#6FFFE9" }
    };
    ...
    window.initParticles = function (mode) {
        ...
        var c = particleColors[mode] || particleColors.dark;
        particlesJS("particles-js", {
            particles: {
                ...
                size: { value: 3, random: true, anim: { enable: false, speed: 19.18081918081918, size_min: .1, sync: false } },
                line_linked: { enable: true, distance: 150, color: c.line, opacity: .4, width: 1 },
    ...
    window.initParticles(isDark ? "dark" : "light");
}, false);